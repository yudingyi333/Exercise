...
c(glm_error(recall~radiologist+age+history+symptoms+menopause+density,data=brca,Ntimes=100),

glm_error(recall~(radiologist+age+history+symptoms+menopause+density)^2,data=brca,Ntimes=100),

glm_error(recall~radiologist*(age+history+symptoms+menopause),data=brca,Ntimes=100),

glm_error(recall~radiologist*(age+history+symptoms+menopause+density),data=brca,Ntimes=100))
